...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Curated vape products for the Australian market. Order via Telegram." },
      { name: "author", content: "Vape Spot" },
      { property: "og:title", content: "Vape Spot — Premium Vape Catalogue" },
      { property: "og:description", content: "Curated vape products for the Australian market." },
